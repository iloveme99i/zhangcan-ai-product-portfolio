...
const d:CaseData={
  ...
  facts:[["项目时间","2026.08"],["我的职责","产品定位、Agent 流程、MVP 范围、版本优先级、验收与团队推进"],["团队规模","7 人跨职能团队"],["测试场景","形势与政策课程小组、思政课程参赛短视频小组"]],
  story:[
    ...
    {label:"职责与分工",title:"我的职责与团队分工",ownership:[
      {label:"我负责",title:"产品与交付管理",detail:"确定目标用户和问题范围，设计 Agent 状态与审批流程，制定 MVP 范围、版本优先级和验收标准，并推动跨职能协作。"},
      {label:"团队共同完成",title:"Web MVP 实现",detail:"团队共同完成 UI 方案、前后端实现、模型接入、测试、Bug 修正和版本交付。"},
      {label:"贡献边界",title:"团队成果不归为个人成果",detail:"作品集只陈述我主导的产品工作；具体代码、视觉和工程实现属于团队共同交付。"}
